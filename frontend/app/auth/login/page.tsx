  ...
  return (
    <>
      <PageBanner
        title="Welcome"
        subtitle="Back"
        description="Sign in to your account to access your wishlist, orders, and more."
        tag="Sign In"
      />
        ...
        <div className="max-w-md mx-auto px-4 sm:px-0">
          ...
          <div className="bg-white p-8 sm:p-10 md:p-12 border border-gray-200 shadow-premium">
            ...
            <div className="text-center mb-10">
              ...
              <h3 className="text-2xl sm:text-3xl font-serif font-light text-black tracking-[2px]">Sign In</h3>
              <p className="text-sm text-gray-400 font-sans font-light mt-2.5 tracking-[1px]">
                Access your WRIST AFFAIR account
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div>
                <div className="flex items-center justify-between mb-2.5">
                  <label className="text-[10px] tracking-[4px] uppercase text-gray-500 font-medium font-sans">
                    Password
                  </label>
                  <Link
                    href="/web/forgot-password"
                    className="text-[10px] text-gray-400 hover:text-black transition-colors font-sans font-light"
                  >
                    Forgot Password?
                  </Link>
                </div>
              ...
              <div className="flex items-center">
                <label className="flex items-center gap-2.5 cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 border border-gray-300 group-hover:border-black focus:outline-none focus:border-black transition-colors"
                  />
                  <span className="text-xs text-gray-400 font-sans font-light group-hover:text-black transition-colors">Remember me</span>
                </label>
              </div>
