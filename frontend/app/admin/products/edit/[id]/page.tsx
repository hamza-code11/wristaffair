...
const EditProductPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    price: '12500',
    stock: '12',
    description: 'A masterpiece of precision and elegance featuring a classic design with modern functionality. This timepiece embodies the perfect balance between tradition and innovation.',
    status: 'Active'
  });
      ...
      <div className="bg-white border border-gray-200 p-4 sm:p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-serif font-light text-black">Edit Product</h2>
              <p className="text-sm text-gray-400 font-sans font-light">Update product #{id}</p>
            </div>
          </div>
          <Link
            href="/admin/products"
