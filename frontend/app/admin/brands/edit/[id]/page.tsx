...
const EditBrandPage: React.FC = () => {
  ...
  const [imagePreview, setImagePreview] = useState<string | null>('/brands/rolex.jpg');
  const [imageFile, setImageFile] = useState<File | null>(null);

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Brand updated:', { ...formData, image: imageFile });
      ...
      <div className="bg-white border border-gray-200 p-4 sm:p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-serif font-light text-black">Edit Brand</h2>
              <p className="text-sm text-gray-400 font-sans font-light">Update brand #{id}</p>
            </div>
          </div>
          <Link
            href="/admin/brands"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm font-sans">/brands/</span>
              <input
                type="text"
                name="slug"
                value={formData.slug}
                ...
                className="w-full px-4 pl-20 py-3 bg-gray-50 border border-gray-200 focus:border-black text-black text-sm placeholder:text-gray-400 focus:outline-none focus:bg-white transition-all"
                required
              />
            </div>
            <p className="mt-1 text-xs text-gray-400 font-sans font-light">
              URL-friendly version of the brand name. Auto-generated from the name.
            </p>
          </div>
