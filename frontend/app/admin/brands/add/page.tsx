...
const AddBrandPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Brand added:', { ...formData, image: imageFile });
      ...
      <div className="bg-white border border-gray-200 p-4 sm:p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-serif font-light text-black">Add Brand</h2>
              <p className="text-sm text-gray-400 font-sans font-light">Create a new brand</p>
            </div>
          </div>
          <Link
            href="/admin/brands"
